...
function App() {
  ...
  const handleAttendance =(ChangeAttendance)=>{
    setList(ChangeAttendance)
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/Attendance" element={<Attendance handleAttendance={handleAttendance} />} />
        <Route path="/Atrecord" element={<Atrecord List={List} />} />
      </Routes>
    </BrowserRouter>
  );
}
